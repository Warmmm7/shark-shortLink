package com.shark.shortlink.project.config;


import com.shark.shortlink.project.mq.consumer.ShortLinkStatsSaveConsumer;
...
import static com.shark.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_GROUP_KEY;
import static com.shark.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_TOPIC_KEY;

/**
 * Redis Stream 消息队列配置 之后用rocketMq
 */
@Configuration
